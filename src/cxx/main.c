...
int main() {
    const char filename[] = "/home/link/workspaces/speech-vad-demo/pcm/processaudio.pcm"; // 读取的文件
    const char output_filename_prefix[] = "out.pcm"; // 保存的文件名
    const char output_dir[] = "/home/link/workspaces/speech-vad-demo/out_pcm"; // 保存的目录
    splitPCM_pro(filename,output_dir);
